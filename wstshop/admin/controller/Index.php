...
use wstshop\admin\model\Staffs;
use wstshop\admin\model\Menus;
use wstshop\admin\model\Index as M;
/**
 * ============================================================================
 * WSTShop网上商店
...
class Index extends Base{
    ...
    public function getVersion(){
    	...
    	$license = WSTConf("CONF.shopLicense");
    	$host = request()->root(true);
    	$url = base64_encode('version='.$version.'&version_md5='.$key."&license=".$license."&host=".$host);
    	$content = file_get_contents('http://www.wstshop.net/index.php?m=Api&c=Download&a=getLastVersion&key='.$url);
    ...
    public function verifyLicense(){
    	...
    	$content = file_get_contents('http://www.wstshop.net/index.php?m=Api&c=License&a=verifyLicense&key='.$key);
    	$json = json_decode($content,true);
    	$rs = array('status'=>1);
